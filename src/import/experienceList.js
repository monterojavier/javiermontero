export default [
  ...
  },
  {
    ...
    skills: '',
    responsibilities: [
      'Deployed API to allow buyers to specify the state they would like to display their ads on the internet.',
      'Focus on privacy by implementing a feature that excluding small regions and works with an Ariane to ensure it’s safe.',
      'Plan, design, and implement a pipeline to periodically generate event records an 85% faster and index it.',
